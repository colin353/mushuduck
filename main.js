...
(function() {
  ...
  BattleStage = (function(_super) {
    ...
    function BattleStage() {
      _ref = BattleStage.__super__.constructor.apply(this, arguments);
      return _ref;
    }
  ...
  window.Card = (function() {
    ...
    Card.prototype.destroy = function() {
      ...
      _results = [];
      for (i = _i = 0, _ref1 = player.cards.length - 1; 0 <= _ref1 ? _i <= _ref1 : _i >= _ref1; i = 0 <= _ref1 ? ++_i : --_i) {
  ...
  window.P_CB_ConversionCard = (function(_super) {
    ...
    P_CB_ConversionCard.prototype.render = function() {
      var i, name, number, picture, _i, _j, _ref1, _ref2;
      picture = "";
    ...
    P_CB_ConversionCard.prototype.activate = function() {
      var has_enough, name, number, _ref1, _ref2, _ref3;
      has_enough = true;
      _ref1 = this.items_from;
      for (name in _ref1) {
        number = _ref1[name];
  ...
  window.BlueberryPieCard = (function(_super) {
    ...
    BlueberryPieCard.prototype.render = function() {
      var name, picture, _i, _len, _ref1;
      picture = "";
      _ref1 = this.items_from;
    ...
    BlueberryPieCard.prototype.activate = function() {
      var has_enough, name, _i, _j, _len, _len1, _ref1, _ref2;
      has_enough = true;
      _ref1 = this.items_from;
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        name = _ref1[_i];
  ...
  window.QuantumFluctuationCard = (function(_super) {
    ...
    QuantumFluctuationCard.prototype.on_production = function() {
      var fruit, fruits, index, name, p, _ref1;
      if (Math.random() < this.amplitude) {
        fruits = [];
        _ref1 = player.products;
        for (name in _ref1) {
          p = _ref1[name];
          fruits.push(name);
        }
  ...
  window.Player = (function() {
    function Player() {
      ...
      _ref1 = ['tomato', 'blueberry', 'purple', 'corn'];
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        p = _ref1[_i];
