...
(function() {
  ...
  window.BiddingStage = (function(_super) {
    ...
    function BiddingStage() {
      ...
      $('.bid').show();
      $('.bid').tap(function() {
        if (player.gold >= this.current_bid) {
          return pycon.transaction({
            action: 'bid',
            data: {
              bidIndex: 0,
              bidAmount: this.current_bid
            }
          }, function() {
            return true;
          });
    ...
    BiddingStage.prototype.updateBidButton = function() {
      return $('.bid').html("Bid $" + this.current_bid);
    };
    ...
    BiddingStage.prototype.new_bid = function(data) {
      if (data.winning) {
        ...
        this.losing();
        return this.current_bid += window.config.minimum_bid;
      }
    };

    BiddingStage.prototype.timer_begin = function(data) {
      var count_down;
