...
(function() {
  var BattleStage, NotificationStage, Production, error, _ref, _ref1,
  ...
  BattleStage = (function(_super) {
    ...
    function BattleStage() {
      _ref1 = BattleStage.__super__.constructor.apply(this, arguments);
      return _ref1;
    }

    BattleStage.prototype.end = function() {
      player.products['tomato'].amount = 0;
      return BattleStage.__super__.end.apply(this, arguments);
    };
  ...
  window.Card = (function() {
    ...
    Card.prototype.destroy = function() {
      ...
      _results = [];
      for (i = _i = 0, _ref2 = player.cards.length - 1; 0 <= _ref2 ? _i <= _ref2 : _i >= _ref2; i = 0 <= _ref2 ? ++_i : --_i) {
  ...
  window.P_CB_ConversionCard = (function(_super) {
    ...
    P_CB_ConversionCard.prototype.render = function() {
      var i, name, number, picture, _i, _j, _ref2, _ref3;

      picture = "";
      _ref2 = this.items_from;
      for (name in _ref2) {
        number = _ref2[name];
    ...
    P_CB_ConversionCard.prototype.activate = function() {
      var has_enough, name, number, _ref2, _ref3, _ref4;
  ...
  window.BlueberryPieCard = (function(_super) {
    ...
    BlueberryPieCard.prototype.render = function() {
      var name, picture, _i, _len, _ref2;
    ...
    BlueberryPieCard.prototype.activate = function() {
      var has_enough, name, _i, _j, _len, _len1, _ref2, _ref3;
  ...
  window.QuantumFluctuationCard = (function(_super) {
    ...
    QuantumFluctuationCard.prototype.on_production = function() {
      var fruit, fruits, index, name, p, _ref2;

      if (Math.random() < this.amplitude) {
        fruits = [];
        _ref2 = player.products;
        for (name in _ref2) {
          p = _ref2[name];
          fruits.push(name);
        }
  ...
  window.go = function() {
    ...
    pycon.register_for_event('stageBegin', function(data) {
      ...
      } else if (data.stageType === 'Notification' || data.stageType === 'Title') {
  ...
  window.Player = (function() {
    function Player() {
      ...
      _ref2 = ['tomato', 'blueberry', 'purple', 'corn'];
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        p = _ref2[_i];
  ...
  window.TradingStage = (function(_super) {
    ...
    TradingStage.prototype.bump = function() {
      var card, items, name, p, _i, _len, _ref2, _ref3;
    ...
    TradingStage.prototype.timer_begin = function(countdown) {
      ...
      do_production = function() {
        return me.yield_production.call(me);
      };
      this.timers.push(setInterval(count_down, 1000));
      this.timers.push(setInterval(do_production, window.config.production_period * 1000));
      return updateCountdown();
    };
    ...
    TradingProduct.prototype.sell = function() {
      ...
      if (this.product.amount > 0) {
        ...
        pycon.transaction({
          ...
          var card, card_bonus, _i, _len, _ref2;
